...
Animation.prototype.add_buttons = function() {
    ...
    button1.addEventListener('click', function() { animate.start(); }, true);
    button1.setAttribute('id', 'animate_button1');
    
    var button2 = button1.cloneNode(true);
    button2.addEventListener('click', function() { animate.start(); }, true);
...
Animation.prototype.play = function() {
    ...
    this.interval = window.setInterval(function() { animate.show_frame(); }, delay);
}
