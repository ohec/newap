...
(function (e) {
    ...
    e.rea.extend(function () {
        ...
        var b = {
            ...
            RUNTIME:         {
                BROWSER:                     e ? "opera" : "chrome",
                CHROME:                      !e,
                OPERA:                       e,
                BROWSER_VERSION:             a,
                WEBKIT_VERSION:              d,
                FAST_EXEC_SUPPORT:           !0,
                DETECT_CONSTRUCTORS_BY_KEYS: 60 <= a,
                ALLOWS_FILE_SCHEME_ACCESS:   null,
                MAX_SCRIPTS:                 1E3,
                WEBREQUEST_XHR_SUPPORT:      !0,
                WEBREQUETS_WEBSOCKET:        58 <= a,
                CAN_SAVEAS_ZIP:              !0,
                CONTEXT_MENU:                !0,
                INCOGNITO_MODE:              !0,
            },
            ACTIONMENU:      {COLUMNS: 3, CLOSE_ALLOWED: !0, MIN_DELAY: c ? 150 : 0},
            OPTIONPAGE:      {CLOSE_ALLOWED: !1},
            DB:              {USE: null, DEFAULT: "chromeStorage"},
            XMLHTTPREQUEST:  {RETRIES: 0, PARTIAL_SIZE: 16777216, COOKIE_PASSTHROUGH: !1},
            ...
            REQUESTS:        {
                ...
                SENDS_ORIGIN:             !0,
                GET_INTERNAL_PATH_REGEXP: function (a, c) {
                    var d = /(\/|\.|\+|\?|\||\(|\)|\[|\]|\{|\}|\\)/g;
    ...
    if (void 0 !== rea.globals._content) {
        ...
        Registry.require(["page.js"], function () {
            ...
            var c = !1, e = function (a, b, d) {
                ...
                }, a      = location.pathname + location.search,
                b         = "TM_" + rea.runtime.short_id + window.btoa(a.length + a).substr(0, 255).replace(/[#=\/]/g, "_"),
                d         = function () {
